...
import com.example.inspiredstock.databinding.ActivityPerformanceMainBinding;
...
public class PerformanceMain extends AppCompatActivity {
    ...
    private void showSupplierReportDialog() {
        try {
            View dialogView = LayoutInflater.from(this).inflate(R.layout.sales_custome_dialog_sample, null);
            AlertDialog alertDialog = new AlertDialog.Builder(this, R.style.TransparentDialog)
                    .setView(dialogView)
                    .show();

            RadioButton currentMonth = dialogView.findViewById(R.id.currentMonthRadio);
            RadioButton currentWeek = dialogView.findViewById(R.id.CurrentWeekRadio);
            RadioButton currentYear = dialogView.findViewById(R.id.CurrentYearRadio);
            RadioButton last60 = dialogView.findViewById(R.id.lastSixtyRadio);
            RadioButton last30 = dialogView.findViewById(R.id.lastThirtyRadio);
            RadioButton last90 = dialogView.findViewById(R.id.lastNinetyRadio);
            Button ok = dialogView.findViewById(R.id.OKRadioButton);
            Button cancel = dialogView.findViewById(R.id.CancelRadioButton);
            ...
            ok.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    // Handle radio button selections and perform actions accordingly

                    alertDialog.dismiss();
                }
            });

            // Add other dialog initialization code...
